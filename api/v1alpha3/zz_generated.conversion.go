...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*ControlPlaneConfig)(nil), (*v1beta1.ControlPlaneConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha3_ControlPlaneConfig_To_v1beta1_ControlPlaneConfig(in *ControlPlaneConfig, out *v1beta1.ControlPlaneConfig, s conversion.Scope) error {
	// WARNING: in.InitConfig requires manual conversion: does not exist in peer-type
